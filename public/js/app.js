! function(e) {
    ...
    (function(t, n) {
        ...
        function Pe(e, t, n) {
            ...
            if (r && (e = Pe(e, r, n)), t.mixins)
                for (var i = 0, o = t.mixins.length; i < o; i++) e = Pe(e, t.mixins[i], n);
            var a, s = {};
            for (a in e) u(a);
        ...
        function jt() {
            ...
            var n = Et.slice(),
                r = kt.slice();
            Ot = kt.length = Et.length = 0, St = {}, At = $t = !1,
                function(e) {
        ...
        function yn(e, t, n, r) {
            ...
            e.prototype._init = function(e) {
                ...
                t._uid = ln++, t._isVue = !0, e && e._isComponent ? function(e, t) {
                    ...
                    }(t, e) : t.$options = Pe(fn(t.constructor), e || {}, t), t._renderProxy = t, t._self = t,
                    function(e) {
                        var t = e.$options,
                            n = t.parent;
                        if (n && !t.abstract) {
        ...
        ! function(e) {
            ...
            Object.defineProperty(e, "config", t), e.util = {
                ...
                }), e.options._base = e, $(e.options.components, wn),
                function(e) {
                    e.use = function(e) {
        ...
        function Yr(e, t) {
            ...
            if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
                ...
                var d = function(e, t) {
                    var n, r = {};
                    if (t)
                        for (var i = e; i.componentInstance;)(i = i.componentInstance._vnode) && i.data && (n = Ur(i.data)) && $(r, n);
                    (n = Ur(e.data)) && $(r, n);
        ...
        function Ai(e, t, n) {
            ...
            if (!i || Array.isArray(r)) {
                for (var o, a, s = 0, u = e.options.length; s < u; s++)
                    if (a = e.options[s], i) o = I(r, Oi(a)) > -1, a.selected !== o && (a.selected = o);
        ...
        var _o, Co, To, ko, Eo, So, Ao, $o, Oo = /^@|^v-on:/,
            jo = /^v-|^@|^:/,
            No = /([^]*?)\s+(?:in|of)\s+([^]*)/,
            Do = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/,
            Lo = /^\(|\)$/g,
        ...
        function Ho(e, t) {
            var n, r;
            (r = Tr(n = e, "key")) && (n.key = r), e.plain = !e.key && !e.attrsList.length,
                function(e) {
                    var t = Tr(e, "ref");
            ...
            ! function(e) {
                ...
                for (t = 0, n = u.length; t < n; t++) {
                    if (r = i = u[t].name, o = u[t].value, jo.test(r))
                        if (e.hasBindings = !0, (a = Uo(r)) && (r = r.replace(Po, "")), Ro.test(r)) r = r.replace(Ro, ""), o = vr(o), s = !1, a && (a.prop && (s = !0, "innerHtml" === (r = C(r)) && (r = "innerHTML")), a.camel && (r = C(r)), a.sync && Cr(e, "update:" + C(r), Sr(o, "$event"))), s || !e.component && Ao(e.tag, e.attrsMap.type, r) ? br(e, r, o) : wr(e, r, o);
                        else if (Oo.test(r)) r = r.replace(Oo, ""), Cr(e, r, o, a, !1);
                    else {
        ...
        var Qo, Go, Jo = {
                ...
                directives: {
                    model: function(e, t, n) {
                        ...
                        else if (!q.isReservedTag(o)) return Er(e, r, i), !1;
                        return !0
                    },
                    text: function(e, t) {
        ...
        var Ta, ka, Ea = (Ta = function(e, t) {
            ...
            function t(t, n) {
                ...
                if (r.warn = function(e, t) {
                    ...
                    for (var a in n.modules && (r.modules = (e.modules || []).concat(n.modules)), n.directives && (r.directives = $(Object.create(e.directives || null), n.directives)), n) "modules" !== a && "directives" !== a && (r[a] = n[a]);
                var s = Ta(t, r);
            ...
            ! function(t, n) {
                ...
                function x(e, t, n, r, i) {
                    ...
                    for (f.textContent = "", d = 0; o = p[d++];)
                        ...
                        else if (c = le.contains(o.ownerDocument, o), a = b(f.appendChild(o), "script"), c && w(a), n)
                    ...
                    if (1 === t.nodeType) {
                        if (Oe.hasData(e) && (o = Oe.access(e), a = Oe.set(t, o), c = o.events))
                            for (i in delete a.handle, a.events = {}, c)
                                for (n = 0, r = c[i].length; n < r; n++) le.event.add(t, i, c[i][n]);
                ...
                function j(e, t, n, r) {
                    ...
                    if (p && (a = (i = x(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
                        ...
                        if (u)
                            for (l = s[s.length - 1].ownerDocument, le.map(s, A), f = 0; f < u; f++) c = s[f], Be.test(c.type || "") && !Oe.access(c, "globalEval") && le.contains(l, c) && (c.src ? le._evalUrl && le._evalUrl(c.src) : o(c.textContent.replace(Ze, ""), l))
                    }
                    return e
                }
                ...
                function U(e, t, n) {
                    ...
                    for (function(e, t) {
                            var n, r, i, o, a;
                            for (n in e)
                                if (i = t[r = le.camelCase(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = le.cssHooks[r]) && "expand" in a)
                ...
                le.fn = le.prototype = {
                    ...
                    var e, t, n, r, i, o, a = arguments[0] || {},
                        ...
                        u = arguments.length,
                        c = !1;
                    for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || le.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
                        if (null != (e = arguments[s]))
                            for (t in e) n = a[t], a !== (r = e[t]) && (c && r && (le.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && le.isPlainObject(n) ? n : {}, a[t] = le.extend(c, o, r)) : void 0 !== r && (a[t] = r));
                    return a
                }, le.extend({
                    ...
                    function p(e, t, n) {
                        ...
                        return t.first ? function(t, n, i) {
                            ...
                            if (u) {
                                ...
                                for (; t = t[r];)
                                    if (1 === t.nodeType || a)
                                        if (l = (f = t[M] || (t[M] = {}))[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                                        else {
                                ...
                                CHILD: function(e, t, n, r, i) {
                                    ...
                                    return 1 === r && 0 === i ? function(e) {
                                        ...
                                        if (m) {
                                            ...
                                            } else if (y && (b = d = (c = (l = (f = (p = t)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === q && c[1]), !1 === b)
                                                for (;
                                                    (p = ++d && p && p[v] || (b = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++b || (y && ((l = (f = p[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [q, b]), p !== t)););
                ...
                (le.fn.init = function(e, t, n) {
                    ...
                    if (n = n || xe, "string" == typeof e) {
                        ...
                        if (r[1]) {
                            if (t = t instanceof le ? t[0] : t, le.merge(this, le.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : Y, !0)), be.test(r[1]) && le.isPlainObject(t))
                ...
                var Ae = function(e, t, n, r, i, o, a) {
                        var s = 0,
                            ...
                            c = null == n;
                        if ("object" === le.type(n))
                            for (s in i = !0, n) Ae(e, t, s, n[s], !0, o, a);
                        else if (void 0 !== r && (i = !0, le.isFunction(r) || (a = !0), c && (a ? (t.call(e, r), t = null) : (c = t, t = function(e, t, n) {
                ...
                h.uid = 1, h.prototype = {
                    ...
                    set: function(e, t, n) {
                        ...
                        if ("string" == typeof t) i[le.camelCase(t)] = n;
                        else
                            for (r in t) i[le.camelCase(r)] = t[r];
                        return i
                    },
                    get: function(e, t) {
                ...
                le.event = {
                    ...
                    add: function(e, t, n, r, i) {
                        ...
                        if (m)
                            for (n.handler && (n = (o = n).handler, i = o.selector), i && le.find.matchesSelector(ze, i), n.guid || (n.guid = le.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                        ...
                        if (m && (u = m.events)) {
                            for (c = (t = (t || "").match(ke) || [""]).length; c--;)
                                if (d = v = (s = Ke.exec(t[c]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
                                    ...
                                    for (d in u) le.event.remove(e, d + t[c], n, r, !0);
                            le.isEmptyObject(u) && Oe.remove(e, "handle events")
                        }
                    },
                    dispatch: function(e) {
                        var t, n, r, i, o, a, s = le.event.fix(e),
                            u = new Array(arguments.length),
                            c = (Oe.get(this, "events") || {})[s.type] || [],
                            l = le.event.special[s.type] || {};
                        for (u[0] = s, t = 1; t < arguments.length; t++) u[t] = arguments[t];
                        if (s.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, s)) {
                            for (a = le.event.handlers.call(this, s, c), t = 0;
                                (i = a[t++]) && !s.isPropagationStopped();)
                                for (s.currentTarget = i.elem, n = 0;
                                    (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, void 0 !== (r = ((le.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
                ...
                le.extend({
                    ...
                    clone: function(e, t, n) {
                        ...
                        if (!(ce.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || le.isXMLDoc(e)))
                            for (a = b(s), r = 0, i = (o = b(e)).length; r < i; r++) O(o[r], a[r]);
                        if (t)
                            if (n)
                                for (o = o || b(e), a = a || b(s), r = 0, i = o.length; r < i; r++) $(o[r], a[r]);
                            else $(e, s);
                ...
                ! function() {
                    ...
                    var t, r, i, o, a = Y.createElement("div"),
                ...
                le.Animation = le.extend(U, {
                        ...
                        prefilters: [function(e, t, n) {
                            ...
                            if ((u = !le.isEmptyObject(t)) || !le.isEmptyObject(d))
                                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = m && m.display) && (c = Oe.get(e, "display")), "none" === (l = le.css(e, "display")) && (c ? l = c : (y([e], !0), c = e.style.display || c, l = le.css(e, "display"), y([e]))), ("inline" === l || "inline-block" === l && null != c) && "none" === le.css(e, "float") && (u || (p.done(function() {
                                        h.display = c
                                    }), null == c && (l = h.display, c = "none" === l ? "" : l)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function() {
                                        h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                                    })), u = !1, d) u || (m ? "hidden" in m && (v = m.hidden) : m = Oe.access(e, "fxshow", {
                                    display: c
                ...
                le.fn.extend({
                    ...
                    toggleClass: function(e, t) {
                        ...
                        return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : le.isFunction(e) ? this.each(function(n) {
                            ...
                            var t, r, i, o;
                            if ("string" === n)
                                for (r = 0, i = le(this), o = e.match(ke) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                ...
                le.extend(le.event, {
                    trigger: function(e, t, r, i) {
                        ...
                        if (a = s = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !yt.test(d + le.event.triggered) && (d.indexOf(".") > -1 && (d = (h = d.split(".")).shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, (e = e[le.expando] ? e : new le.Event(d, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : le.makeArray(t, [e]), f = le.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                            ...
                            for (o = 0;
                                (a = p[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? u : f.bindType || d, (l = (Oe.get(a, "events") || {})[e.type] && Oe.get(a, "handle")) && l.apply(a, t), (l = c && a[c]) && l.apply && $e(a) && (e.result = l.apply(a, t), !1 === e.result && e.preventDefault());
                ...
                It.href = bt.href, le.extend({
                    ...
                    ajax: function(e, t) {
                        ...
                        var i, o, a, s, u, c, l, f, p, d, h = le.ajaxSetup({}, t),
                            v = h.context || h,
                ...
                le.ajaxSetup({
                    ...
                    var i, o, a, s = !1 !== e.jsonp && (Ft.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ft.test(e.data) && "data");
                    ...
                    setOffset: function(e, t, n) {
                        var r, i, o, a, s, u, c = le.css(e, "position"),
                            l = le(e),
                            f = {};
    ...
    ! function(t, n) {
            ...
            function xe(e, t, n, r, i, o) {
                return r && !r[w] && (r = xe(r)), i && !i[w] && (i = xe(i, o)), se(function(o, a, s, u) {
                    var c, l, f, p = [],
                        ...
                        g = n ? i || (o ? e : h || r) ? [] : a : m;
                    if (n && n(m, g, s, u), r)
                        for (c = we(g, d), r(c, [], s, u), l = c.length; l--;)(f = c[l]) && (g[d[l]] = !(m[d[l]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
        ...
        (C.fn.init = function(e, t, n) {
            ...
            if (n = n || D, "string" == typeof e) {
                ...
                if (r[1]) {
                    if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : a, !0)), j.test(r[1]) && C.isPlainObject(t))
        ...
        function xe(e, t, n, r, i) {
            ...
            for (f.textContent = "", d = 0; o = p[d++];)
                ...
                else if (c = C.contains(o.ownerDocument, o), a = me(f.appendChild(o), "script"), c && ge(a), n)
        ...
        C.event = {
            ...
            add: function(e, t, n, r, i) {
                ...
                if (m)
                    for (n.handler && (n = (o = n).handler, i = o.selector), i && C.find.matchesSelector(_e, i), n.guid || (n.guid = C.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
        ...
        function Me(e, t, n, r) {
            ...
            if (p && (o = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                ...
                if (s)
                    for (l = a[a.length - 1].ownerDocument, C.map(a, Re), f = 0; f < s; f++) u = a[f], he.test(u.type || "") && !Y.access(u, "globalEval") && C.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(u.src) : x(u.textContent.replace(De, ""), l, u))
            }
            return e
        }
        ...
        C.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                    for (a = me(l), r = 0, i = (o = me(e)).length; r < i; r++) s = o[r], u = a[r], void 0, "input" === (c = u.nodeName.toLowerCase()) && pe.test(s.type) ? u.checked = s.checked : "input" !== c && "textarea" !== c || (u.defaultValue = s.defaultValue);
                if (t)
                    if (n)
                        for (o = o || me(e), a = a || me(l), r = 0, i = o.length; r < i; r++) Pe(o[r], a[r]);
                    else Pe(e, l);
        ...
        C.Animation = C.extend(lt, {
                ...
                prefilters: [function(e, t, n) {
                    ...
                    if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                        for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = m && m.display) && (c = Y.get(e, "display")), "none" === (l = C.css(e, "display")) && (c ? l = c : (fe([e], !0), c = e.style.display || c, l = C.css(e, "display"), fe([e]))), ("inline" === l || "inline-block" === l && null != c) && "none" === C.css(e, "float") && (u || (p.done(function() {
                                h.display = c
                            }), null == c && (l = h.display, c = "none" === l ? "" : l)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function() {
                                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                            })), u = !1, d) u || (m ? "hidden" in m && (v = m.hidden) : m = Y.access(e, "fxshow", {
                            display: c
        ...
        C.extend(C.event, {
            trigger: function(e, t, r, i) {
                ...
                if (s = d = u = r = r || a, 3 !== r.nodeType && 8 !== r.nodeType && !bt.test(m + C.event.triggered) && (m.indexOf(".") > -1 && (m = (g = m.split(".")).shift(), g.sort()), l = m.indexOf(":") < 0 && "on" + m, (e = e[C.expando] ? e : new C.Event(m, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : C.makeArray(t, [e]), p = C.event.special[m] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, t))) {
                    ...
                    for (o = 0;
                        (s = v[o++]) && !e.isPropagationStopped();) d = s, e.type = o > 1 ? c : p.bindType || m, (f = (Y.get(s, "events") || {})[e.type] && Y.get(s, "handle")) && f.apply(s, t), (f = l && s[l]) && f.apply && G(s) && (e.result = f.apply(s, t), !1 === e.result && e.preventDefault());
    ...
    (function(e, r) {
        ...
        (function() {
            ...
            var At = {
                ...
                It = Lt && "object" == typeof r && r && !r.nodeType && r,
                Rt = It && It.exports === Lt,
                Pt = Rt && jt.process,
                Mt = function() {
                    try {
            ...
            var In = function e(t) {
                var n, r = (t = null == t ? Dt : In.defaults(Dt.Object(), t, In.pick(Dt, Tt))).Array,
                    i = t.Date,
                    Ye = t.Error,
                    Ze = t.Function,
                    et = t.Math,
                ...
                function yi(e, t, n) {
                    var r = -1;
                    return t = Zt(t.length ? t : [Ou], gn(Po())),
                        function(e, t) {
                            var n = e.length;
                ...
                return hr.after = function(e, t) {
                    ...
                    var i, a, s = Ks({}, t.imports, r.imports, So),
                        u = iu(s),
                        c = yn(s, u),
                        l = 0,
                        f = t.interpolate || Ge,
                        ...
                        computeStyle: {
                            ...
                            fn: function(e, t) {
                                ...
                                var a = void 0 !== o ? o : t.gpuAcceleration,
                                    ...
                                    h = void 0,
                                    v = void 0;
                                if (v = "bottom" === l ? -s.height + c.bottom : c.top, h = "right" === f ? -s.width + c.right : c.left, a && p) u[p] = "translate3d(" + h + "px, " + v + "px, 0)", u[l] = 0, u[f] = 0, u.willChange = "transform";
                                else {
                                    var m = "bottom" === l ? -1 : 1,
                                        g = "right" === f ? -1 : 1;
    ...
    function(e) {
        ...
        v.prototype.activate = function() {
            ...
            var t = e(s).outerHeight() || 0,
                ...
                r = e(window).height(),
                f = e(c).height() || 0;
            if (e("body").hasClass(d)) e(o).css("min-height", r - t);
            else {
                var p;
    ...
    ! function(e) {
        ...
        function y(e, t, n) {
            ...
            if (/^(ch|di|in)/.test(n) && !p) b(e, f);
            else if (/^(un|en|de)/.test(n) && p) w(e, f);
            else if (n == c)
                for (var d in p) p[d] ? b(e, d, !0) : w(e, d, !0);
        ...
        methods: {
            submit: function() {
                ...
                this.form.post("/register").then(function(t) {
                    ...
                    console.log(e.trans("message.registererror") + ":" + t)
                })
            },
    ...
    e.exports = {
        render: function() {
            ...
            return n("form", {
            ...
            }, [e._v(" " + e._s(e.trans("message.registered")) + " "), n("i", {
                staticClass: "fa fa-refresh fa-spin"
            }), e._v(" " + e._s(e.trans("message.entering")))]), e._v(" "), n("div", {
                ...
                attrs: {
                    type: "text",
                    placeholder: e.trans("message.fullname"),
                    name: "name",
                    value: "",
                    autofocus: ""
                },
                ...
                attrs: {
                    type: "email",
                    placeholder: e.trans("message.email"),
                    name: "email",
                    value: ""
                },
                domProps: {
                ...
                attrs: {
                    type: "password",
                    placeholder: e.trans("message.password"),
                    name: "password"
                },
                domProps: {
                    value: e.form.password
                ...
                attrs: {
                    type: "password",
                    placeholder: e.trans("message.retypepassword"),
                ...
                domProps: {
                    textContent: e._s(e.trans("message.conditions"))
                }
            })])])])]), e._v(" "), n("div", {
                ...
                domProps: {
                    textContent: e._s(e.trans("message.register"))
                }
    ...
    t.default = {
        ...
        computed: {
            placeholder: function() {
                return "email" === this.name ? this.trans("message.email") : this.trans("message.username")
            },
            type: function() {
        ...
        methods: {
            submit: function() {
                ...
                this.form.post("/login").then(function(t) {
                    ...
                    console.log(e.trans("message.loginerror") + ":" + t)
                })
            },
            adddomain: function() {
    ...
    e.exports = {
        render: function() {
            ...
            return n("form", {
            ...
            }, [e._v(" " + e._s(e.trans("message.loggedin")) + " "), n("i", {
                staticClass: "fa fa-refresh fa-spin"
            }), e._v(" " + e._s(e.trans("message.entering")))]), e._v(" "), "email" === e.type ? n("div", {
                staticClass: "form-group has-feedback",
                class: {
                    "has-error": e.form.errors.has("email")
                }
            ...
            }), e._v(" " + e._s(e.trans("message.remember")) + "\n    ")])])]), e._v(" "), n("div", {
                ...
                domProps: {
                    textContent: e._s(e.trans("message.buttonsign"))
                }
            }, [e.form.submitting ? n("i", {
                staticClass: "fa fa-refresh fa-spin"
            }) : e._e()])])])])
        ...
        methods: {
            submit: function() {
                ...
                this.form.post("/password/email").then(function(t) {
                    ...
                    console.log(e.trans("message.sendpassword") + ":" + t)
                })
            },
            clearErrors: function(e) {
    ...
    e.exports = {
        render: function() {
            ...
            return n("form", {
                ...
                staticClass: "fa fa-refresh fa-spin"
            }) : e._e(), e._v(" " + e._s(e.trans("message.sendpassword")))])]), e._v(" "), n("div", {
                staticClass: "col-xs-2"
            })])])
        },
        staticRenderFns: []
        ...
        methods: {
            submit: function() {
                ...
                this.form.post("/password/reset").then(function(t) {
                    ...
                    console.log(e.trans("message.passwordreset") + ":" + t)
                })
            },
            clearErrors: function(e) {
    ...
    e.exports = {
        render: function() {
            ...
            return n("form", {
                ...
                staticClass: "fa fa-refresh fa-spin"
            }) : e._e(), e._v(" " + e._s(e.trans("message.passwordreset")))])]), e._v(" "), n("div", {
                staticClass: "col-xs-2"
            })])])
        },
        staticRenderFns: []
